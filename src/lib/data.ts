...
export const products: Product[] = [
  {
    ...
    description:
      "The flagship tee of the Project-1957 line. Heavyweight American fleece with the adinkra mark at the collar and the independence artwork printed across the back.",
    details: [
      "100% COTTON HEAVY AMERICAN FLEECE",
      "GARMENT DYED PIGMENT",
      "HAND PRINTED BACK ARTWORK",
      "NVRSËYNVR LABEL",
      "MADE IN GHANA",
    ],
    sizes: TEE_SIZES,
  ...
  },
  {
    ...
    category: "T-SHIRT",
    price: 250,
    images: ["/images/lifestyle/ghana-flag-man.webp"],
    description:
      "Named for the bag that carried whole lives across borders. Raised hands in red, gold and green break the chain across the back. A story of leaving, returning, and carrying home with you.",
    details: [
      "100% COTTON HEAVY AMERICAN FLEECE",
      "MULTI-COLOUR BACK PRINT",
      "HAND PRINTED GRAPHICS",
      "NVRSËYNVR LABEL",
      "MADE IN GHANA",
    ],
  ...
  },
  {
    ...
    category: "T-SHIRT",
    price: 200,
    images: ["/images/lifestyle/girl-black-tee-cap.webp"],
    description:
    ...
    colors: [
      {
        ...
        sku: "CLS-TEE-BLK",
        front: "/images/products/survivors-black-front.webp",
        back: "/images/products/classic-tee-black-back.webp",
      },
    ],
    collection: "project-1957-freedom",
    featured: true,
  ...
  },
  {
    ...
    category: "T-SHIRT",
    price: 200,
    images: ["/images/products/white-tee-flatlay.webp"],
    description:
    ...
    colors: [
      {
        ...
        sku: "CLS-TEE-WHT",
        front: "/images/products/survivors-white-front.webp",
        back: "/images/products/white-tee-closeup.webp",
      },
    ],
    collection: "project-1957-freedom",
    featured: false,
